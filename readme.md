...
---------------
NOTE: this workspace folder contains also a job named "job-sqlite" with two sample databases, but this is only an example and your databases can be
placed anywhere.
---------------
...
---------------
**TIP**: First time consider to start Data Mover in debug mode and 
look at generated log to ensure all is working fine.
If all is working fine you should se a log file in each job directory and also some autogenerated json
files with your database schema.
---------------
